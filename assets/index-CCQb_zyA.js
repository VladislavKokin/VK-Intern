...
function _n({ page: e, ...t }) {
  ...
  return i
    ? n
      ? x.createElement(yn, { page: e, matches: i, ...t })
...
function yn({ page: e, matches: t, ...n }) {
  let r = ot(),
    ...
    o = x.useMemo(() => {
      ...
      let n = en(e, a, i.unstable_trailingSlashAwareDataRequests, `rsc`),
        o = !1,
        s = [];
      for (let e of t)
...
var Sn =
  ...
  window.document.createElement !== void 0;
try {
  Sn && (window.__reactRouterVersion = `7.14.0`);
} catch {}
function Cn({
  basename: e,
  children: t,
...
function kn({ getKey: e, storageKey: t, ...n }) {
  ...
  return x.createElement(`script`, {
    ...
    dangerouslySetInnerHTML: {
      __html: `(${c})(${Qt(JSON.stringify(t || Rn))}, ${Qt(JSON.stringify(s))})`,
    },
  });
}
...
var Wn = g(),
  ...
  Kn = ({ images: e, favorites: t, toggleFavorite: n }) =>
    (0, j.jsxs)(`div`, {
      className: `conteinerCats`,
      children: [
        e.map(({ id: e, url: r }) =>
          (0, j.jsxs)(
            `div`,
            {
              className: `conteinerImage`,
              children: [
                (0, j.jsx)(`img`, {
                  className: `imageCats`,
                  src: r,
                ...
                (0, j.jsx)(`button`, {
                  className: `buttonLike ${t.includes(e) ? `active` : ``}`,
                  onClick: () => n(e),
                }),
              ],
            },
        ...
        (0, j.jsx)(`div`, {
          className: `loading`,
          children: `... загружаем еще котиков ...`,
        }),
      ],
    }),
  qn = ({ images: e, favorites: t, toggleFavorite: n }) => {
    ...
    return (0, j.jsx)(`div`, {
      ...
      children: r.length
        ...
        : (0, j.jsx)(`p`, { children: `Нет любимых котиков` }),
    });
  };
(0, Wn.createRoot)(document.getElementById(`root`)).render(
                ...
                children: (0, j.jsxs)(`div`, {
                  children: [
                    ...
                    (0, j.jsx)(En, {
                      to: `/catalog`,
                      children: (0, j.jsx)(`button`, {
                        className: `buttonLikeCats`,
                        children: `Любимые котики`,
                      }),
                    }),
                  ],
                }),
